...
CREATE TABLE IF NOT EXISTS `progs` (
  ...
  `mob1` text NOT NULL,
  `eid1` enum('ΠΕ05','ΠΕ06','ΠΕ07','ΠΕ08','ΠΕ11','ΠΕ16','ΠΕ18.41','ΠΕ19-20','ΠΕ60','ΠΕ70','Άλλο') NOT NULL,
  `his1` enum('Όχι','Ναι') NOT NULL,
  `qua1` enum('Όχι','Ναι') NOT NULL,
  `nam2` text NOT NULL,
  `email2` text NOT NULL,
  `mob2` text NOT NULL,
  `eid2` enum('','ΠΕ05','ΠΕ06','ΠΕ07','ΠΕ08','ΠΕ11','ΠΕ16','ΠΕ18.41','ΠΕ19-20','ΠΕ60','ΠΕ70','Άλλο') NOT NULL,
  `his2` enum('','Όχι','Ναι') NOT NULL,
  `qua2` enum('','Όχι','Ναι') NOT NULL,
  `nam3` text NOT NULL,
  `email3` text NOT NULL,
  `mob3` text NOT NULL,
  `eid3` enum('','ΠΕ05','ΠΕ06','ΠΕ07','ΠΕ08','ΠΕ11','ΠΕ16','ΠΕ18.41','ΠΕ19-20','ΠΕ60','ΠΕ70','Άλλο') NOT NULL,
